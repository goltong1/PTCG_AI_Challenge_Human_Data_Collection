...
class FinalDayProofGuard:
    ...
    def _game_winning_attack(self,obs,base):
        ...
        if remain<=0 or pv<remain:return None
        ...
        return self._emit([cand[0][1]],'proof:game_winning_attack',attack=cand[0][2],damage=cand[0][0],target=_i(target.get('id')),prizes=remain)

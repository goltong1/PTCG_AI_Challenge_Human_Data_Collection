...
DECK_LIST = [169, 169, 169, 169, 190, 190, 190, 190, 666, 666, 666, 666, 1244, 57, 1152, 1152, 1152, 1152, 1121, 1121, 1121, 1121, 1122, 1122, 1122, 1122, 1097, 1097, 1097, 1147, 1147, 1147, 1147, 1159, 1182, 1182, 1182, 1182, 1185, 1185, 1185, 1185, 1227, 1227, 1227, 1227, 1244, 1244, 1244, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8]
        ...
        try:
            if fp and os.path.isfile(fp):
                with open(fp, "r", encoding="utf-8") as f:
                    parsed = [int(line.strip()) for line in f if line.strip()]
                if len(parsed) == 60:
                    return parsed
        except Exception:
            continue

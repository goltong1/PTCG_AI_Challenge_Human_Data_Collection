"""v31 guarded matchup heuristics with explicit Dragapult/Clefairy cases.
...
try:
    _config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "matchup_v31_config.json")

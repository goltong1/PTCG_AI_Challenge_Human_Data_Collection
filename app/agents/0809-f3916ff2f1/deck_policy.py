...
ARCHETYPE_IDS = {
    ...
    "crustle": {344, 345, 756},
    "lucario": {333, 673, 674, 675, 676, 677, 678},
...
SETUP_TARGET_IDS = {
    ...
    344,       # Dwebble
    169,       # Duraludon before Assemble Alloy / Metal Defender
    646, 647,  # Marnie line
...
def _make_plan(obs: Observation, archetype: str) -> Plan:
    ...
    if archetype == "archaludon":
        ...
        if {333, 677, 678} & set(_MEMORY["revealed"]):
            desired_froslass = 0
...
def _apply_temporal_sequence_guard(scores: list[int], obs: Observation, mine, opponent,
    ...
    * never end a turn while a legal attack or immediately useful evolution
    ...
    lucario_core = plan.archetype == "lucario" and bool({333, 677, 678} & revealed)

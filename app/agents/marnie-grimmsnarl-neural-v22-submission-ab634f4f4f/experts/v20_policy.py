"""Self-play-distilled v18 Marnie's Grimmsnarl ex hybrid agent for CABT.
...
_CORRECTION_PATH = "replay_corrections_v20.json"
if not os.path.exists(_CORRECTION_PATH):
    _CORRECTION_PATH = "/kaggle_simulations/agent/replay_corrections_v20.json"
try:

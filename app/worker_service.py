...
class GameWorkerProxy:
    def __init__(self, session_id: str, timeout: float = 180.0) -> None:
...
class SessionHub:
    def __init__(self, max_sessions: int = 8, idle_seconds: int = 3600) -> None:
    ...
    def get(self, session_id: str) -> GameWorkerProxy:
        with self.lock:
            ...
            worker = GameWorkerProxy(session_id)

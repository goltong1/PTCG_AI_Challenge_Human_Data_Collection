...
:run_server
echo.
echo [CABT] Starting in LAN mode...
echo [CABT] Allow access on private networks if Windows Firewall asks.
echo [CABT] Other devices can connect to this PC's IPv4 address on port 8765.
echo.
